...
for i in range(1):
    ...
    agent1 = QLIndependentBelief('QLIndependentBelief_TM', ExtMiningEnv.game_model, decorrelate=True)
    ...
    control = ExtGameControl(agent1, agent2, max_frames=5e6, log_interval=10000, save_agents_models=True, models_path="c:\\temp\\aamas2025\\models")
